...
PARQUET_PATH: str = os.path.join(BASE, "gradient_specificity_single.parquet")
OUT_DIR: str = os.path.join(BASE, "textgrad_mode_plots")
os.makedirs(OUT_DIR, exist_ok=True)

BOKEH_FONT: str = "system-ui, -apple-system, Segoe UI, Roboto, sans-serif"
MODE_ORDER: List[str] = ["Single", "SSS", "SSC", "SCC", "CCC"] # , "CCC" , "SSS", 
PER_TASK_MODES: List[str] = ["Single", "SSC", "SSS"] # "Single", "SSS", 
ALL_TASK_MODES: List[str] = ["SCC", "CCC"] # , "CCC"
