...
from when_gradients_collide.algorithm.pe2 import PE2GradientComputer
from when_gradients_collide.algorithm.pe2 import PE2LossComputer
from when_gradients_collide.algorithm.pe2 import PE2Optimizer
...
class TestPE2LossComputer:
    ...
    def test_registry_lookup(self):
        from when_gradients_collide.loss_computer import LossComputer
...
class TestPE2GradientComputerPromptConstruction:
    ...
    def test_registry_lookup(self):
        from when_gradients_collide.gradient_computer import GradientComputer
...
class TestPE2OptimizerMetaPrompt:
    ...
    def test_registry_lookup(self):
        from when_gradients_collide.prompt_optimizer import PromptOptimizer
