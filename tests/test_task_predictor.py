...
from when_gradients_collide.task_predictor import parse_task_response, validate_task_response
...
class TestExtractNumericOutputs:
    ...
    def test_integer_values(self):
        from when_gradients_collide.task_predictor import _extract_numeric_outputs
