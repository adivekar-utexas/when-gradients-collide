...
DATASETS: List[Dict] = [
    {
        "name": "SummEval",
        "prefix": ["TextGrad-SummEval-21May2026", "TextGrad-SummEval-22May2026"],
...
MODE_ORDER: List[str] = [ "SCC"] # "SSS", , "CCC", "SSC",
VAL_ORDER: List[str] = [
    # "ob1",
    "mae",
    # "spearman",
...
for ds in DATASETS:
    ...
    for metric_name in METRIC_NAMES:
        ...
        out_path: str = os.path.join(
            OUT_DIR, f"textgrad_{ds_name.lower()}_{metric_name.lower()}.html"
        )
